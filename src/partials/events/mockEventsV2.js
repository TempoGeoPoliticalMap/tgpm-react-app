  ...
  data: [
    {
      ...
      description: "Ongoing war between Russia and Ukraine, including the 2014 annexation of Crimea and the 2022 full-scale invasion.",
    ...
    },
    {
      ...
      name: "Gaza War",
      type: "WARFARE_AND_ARMED_CONFLICTS",
      description: "Military conflict between Israel and Hamas-led Palestinian militant groups in the Gaza Strip, following the Hamas-led attack on Israel on 7 October 2023.",
      ...
      locations: [
        {wikidataId: "Q34763", name: "Gaza City", coordinate: "31.5017,34.4669"}
      ],
      timeStateRelativeToNow: "ONGOING",
    ...
    },
    {
      ...
      countries: [
        {wikidataId: "Q1049", name: "Sudan"}
      ],
      locations: [
        {wikidataId: "Q1963", name: "Khartoum", coordinate: "15.5518,32.5324"}
      ],
      timeStateRelativeToNow: "ONGOING",
    ...
    },
    {
      ...
      type: "WARFARE_AND_ARMED_CONFLICTS",
      description: "Armed conflict in Myanmar following the 2021 military coup, involving the military junta against pro-democracy resistance and ethnic armed organisations.",
      wikipediaUrl: "https://en.wikipedia.org/wiki/Myanmar_civil_war_(2021%E2%80%93present)",
      regions: ["EAST_ASIA_AND_PACIFIC"],
      countries: [
        {wikidataId: "Q836", name: "Myanmar"}
      ],
      locations: [
        {wikidataId: "Q244773", name: "Naypyidaw", coordinate: "19.7450,96.1297"}
      ],
      timeStateRelativeToNow: "ONGOING",
    ...
    },
    {
      ...
      type: "WARFARE_AND_ARMED_CONFLICTS",
      description: "Ongoing multi-sided civil war in Yemen, fought mainly between the Houthi movement and the internationally recognised government.",
      wikipediaUrl: "https://en.wikipedia.org/wiki/Yemeni_civil_war_(2014%E2%80%93present)",
      regions: ["MIDDLE_EAST_AND_NORTH_AFRICA"],
      countries: [
        {wikidataId: "Q805", name: "Yemen"}
      ],
      locations: [
        {wikidataId: "Q82069", name: "Sanaa", coordinate: "15.3694,44.1910"}
      ],
      timeStateRelativeToNow: "ONGOING",
    ...
    },
    {
      ...
      type: "WARFARE_AND_ARMED_CONFLICTS",
      description: "War in Afghanistan from 2001 to 2021, initiated by the United States-led coalition following the September 11 attacks.",
      ...
      locations: [
        {wikidataId: "Q5838", name: "Kabul", coordinate: "34.5253,69.1783"}
      ],
    ...
    },
    {
      ...
      name: "Iraq War",
      type: "WARFARE_AND_ARMED_CONFLICTS",
      description: "War in Iraq from 2003 to 2011, initiated by a United States-led coalition that overthrew the Ba'athist government of Saddam Hussein.",
      ...
      locations: [
        {wikidataId: "Q1530", name: "Baghdad", coordinate: "33.3406,44.4009"}
      ],
      timeStateRelativeToNow: "PAST",
